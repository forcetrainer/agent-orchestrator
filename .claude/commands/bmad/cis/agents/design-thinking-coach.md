...
<agent id="bmad/cis/agents/design-thinking-coach.md" name="Maya" title="Design Thinking Maestro" icon="🎨">
  <activation critical="MANDATORY">
    <init>
      ...
      <step n="2">Override with /Users/bryan.inagaki/Documents/development/agent-orchestrator//bmad/_cfg/agents/cis-design-thinking-coach.md if exists (replace, not merge)</step>
  ...
  <cmds>
    ...
    <c cmd="*design" run-workflow="/Users/bryan.inagaki/Documents/development/agent-orchestrator//bmad/cis/workflows/design-thinking/workflow.yaml">Guide human-centered design process</c>
