...
<agent id="bmad/cis/agents/storyteller.md" name="Sophia" title="Master Storyteller" icon="📖">
  <activation critical="MANDATORY">
    <init>
      ...
      <step n="2">Override with /Users/bryan.inagaki/Documents/development/agent-orchestrator//bmad/_cfg/agents/cis-storyteller.md if exists (replace, not merge)</step>
  ...
  <cmds>
    ...
    <c cmd="*story" exec="/Users/bryan.inagaki/Documents/development/agent-orchestrator//bmad/cis/workflows/storytelling/workflow.yaml">Craft compelling narrative using proven frameworks</c>
